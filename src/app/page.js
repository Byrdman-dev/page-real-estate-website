    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-white py-10 px-6 border-b border-gray-100">
        <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          <div>
            <p className="text-4xl md:text-5xl font-bold text-brand mb-1">35+</p>
            <p className="text-gray-600 uppercase tracking-wide text-sm font-medium">Years Experience</p>
          </div>
          <div>
            <p className="text-4xl md:text-5xl font-bold text-brand mb-1">Lake Charles</p>
            <p className="text-gray-600 uppercase tracking-wide text-sm font-medium">Local Expertise</p>
          </div>
          <div>
            <p className="text-4xl md:text-5xl font-bold text-brand mb-1">Full-Service</p>
            <p className="text-gray-600 uppercase tracking-wide text-sm font-medium">Buying, Selling &amp; Leasing</p>
          </div>
        </div>
      </section>
