    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Quote Section */}
          <div className="mb-12">
            <div className="bg-white p-8 rounded-xl border border-gray-100 border-l-4 border-l-brand shadow-lg max-w-4xl mx-auto">
          ...
          {/* Call to Action */}
          <div className="text-center bg-brand text-white p-12 rounded-xl shadow-2xl">
            ...
            <div>
              <Link href="/contact">
                <button className="bg-white hover:bg-gray-100 text-brand text-xl py-4 px-10 rounded-full transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105">
                  Get In Touch Today
                </button>
              </Link>
            </div>
