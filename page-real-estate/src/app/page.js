          ...
          <div className="p-12">
            ...
            <div className="mt-12 text-left max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <h2 className="text-4xl font-bold text-gray-800 mb-4">About Laurie</h2>
              ...
              <div className="prose prose-lg max-w-none space-y-6">
                ...
                <div className="text-center bg-black/40 backdrop-blur-sm text-white p-8 rounded-xl shadow-lg">
                  ...
                  <div className="inline-block p-3 bg-white/30 rounded-full mb-4">
                  ...
                  <div className="mt-4">
                    <Link href="/contact">
                      <button className="bg-white hover:bg-gray-100 text-gray-800 text-lg py-3 px-8 rounded-xl transition-colors font-semibold">
                        Get In Touch
                      </button>
                    </Link>
                  </div>
