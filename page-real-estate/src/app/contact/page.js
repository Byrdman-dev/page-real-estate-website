  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-32 right-16 w-24 h-24 bg-green-200/20 rounded-full animate-ping" style={{animationDuration: '3s'}}></div>
        <div className="absolute bottom-32 left-16 w-20 h-20 bg-blue-300/25 rounded-full animate-bounce" style={{animationDelay: '1.5s'}}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-purple-200/20 rounded-full animate-pulse" style={{animationDelay: '0.5s'}}></div>
      </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm p-12 rounded-2xl shadow-2xl transform hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 font-medium">(337) 660-3672</p>
                    </div>
                  </div>
                  <p className="text-gray-700">Ready to talk? Give me a call for immediate assistance with all your real estate needs.</p>
                </div>
                
                <div className="bg-gradient-to-r from-green-50 to-green-100 p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-green-600 font-medium">laurie@pagerealestate.com</p>
                    </div>
                  </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-purple-100 p-6 rounded-xl shadow-lg">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center p-2 bg-white/50 rounded-lg">
                      ...
                      <span className="text-purple-600 font-semibold">By appointment</span>
                    </div>
                  </div>
                </div>
                
                <div className="bg-gradient-to-r from-yellow-50 to-orange-100 p-6 rounded-xl shadow-lg">
                  <div className="flex items-center mb-4">
            ...
            <div className="mt-8 text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-xl shadow-lg">
